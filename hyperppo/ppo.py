# nohup python ppo.py --env_id="PushCube-v1"  --num_envs=2048 --update_epochs=8 --num_minibatches=32   --total_timesteps=2_000_000 --eval_freq=10 --num-steps=20 > training_log.txt 2>&1 &

# Run "export CUDA_VISIBLE_DEVICES=3" before doing anything
